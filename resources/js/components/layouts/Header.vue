            ...
            <div class="flex__wrapper--center">
             ...
             <div class="dropdown">
               <!-- <a class="dropdown-item" v-on:click="logout"><i class="fas fa-sign-out-alt pr-2"></i> Logout</a> -->
                <a  href="#"  style="text-decoration:none;margin-left:10px" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img class="dropdown-toggle" :src="'assets/images/profile.png'" alt=""
