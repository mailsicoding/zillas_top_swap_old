            ...
            >
              <div class="sb-sidenav-menu">
                <div class="nav">
                  ...
                  <router-link v-if="can('Dashboard') == true" class="nav-link"  to="/dashboard"><div  class="sb-nav-link-icon ">
                      <i class="fa fa-tachometer-alt" aria-hidden="true"></i>
                    </div>
                    Dashboard
                    </router-link>
                  <router-link v-if="can('Users') == true" class="nav-link"  to="/users"><div  class="sb-nav-link-icon ">
                  ...
                  <router-link v-if="can('Getting Match') == true" class="nav-link"  to="/match-request"><div  class="sb-nav-link-icon ">
                  ...
                  <router-link  v-if="can('Account Setting') == true" class="nav-link"  to="/account-setting"><div  class="sb-nav-link-icon ">
                      <i class="fa fa-tachometer-alt" aria-hidden="true"></i>
                    </div>
                    Account Setting
                    </router-link>

                  <router-link v-if="can('Funds') == true" class="nav-link"  to="/add-funds"><div  class="sb-nav-link-icon ">
                      <i class="fa fa-tachometer-alt" aria-hidden="true"></i>
                    </div>
                    Add Funds
                    </router-link>
